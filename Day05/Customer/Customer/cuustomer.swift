...
class Customer{
    ...
    func registerUser()
    {
        ...
        self.customerName = (String)(readLine()!)
        print("Enter Address : ")
        self.address = (String)(readLine()!)
        print("Enter Email : ")
        self.email = (String)(readLine()!)
        print("Enter Credit Card Info : ")
        self.creditCardInfo = (String)(readLine()!)
        print("Enter Shipping Info : ")
        self.shippingInfo = (String)(readLine()!)
           }
    }
